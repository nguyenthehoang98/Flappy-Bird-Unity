...
public class PlayerController : MonoBehaviour {
	...
	private readonly PlayerJump playerJump = new PlayerJump();
	...
	{
		playerJump.Update(deltaTime);
		Vector3 position = transform.position;
		transform.position = new Vector3(position.x, position.y + playerJump.GetDirection(deltaTime));
		//Debug.Log(playerJump.GetDirection(Time.deltaTime));
	}
